    ...
    return (
        <div className="md:w-1/5 bg-blueSidebar min-h-screen flex flex-col">
            ...
            <div className="flex flex-col flex-grow py-6">
                ...
                <div className={`w-full text-customBlue text-sm flex items-center py-3 cursor-pointer ${selected === 'home' ? 'bg-blueSelect' : 'hover:bg-blueSelect'}`} onClick={() => handleClick('home')}>
                    <BiSolidHome className="w-5 h-5 ml-10" />
                    <h4 className={`ml-3 ${selected === 'home' ? 'font-bold' : ''}`}>Inicio</h4>
                </div>
                <div className={`w-full text-customBlue text-sm flex items-center py-3 cursor-pointer ${selected === 'users' ? 'bg-blueSelect' : 'hover:bg-blueSelect'}`} onClick={() => handleClick('users')}>
                    <FaUser className="w-5 h-5 ml-10" />
                    <h4 className={`ml-5 ${selected === 'users' ? 'font-bold' : ''}`}>Usuarios</h4>
                </div>
                <div className={`w-full text-customBlue text-sm flex items-center py-3 cursor-pointer ${selected === 'publicaciones' ? 'bg-blueSelect' : 'hover:bg-blueSelect'}`} onClick={() => handleClick('publicaciones')}>
                    <FaMessage className="w-4 h-4 ml-10" />
                    <h4 className={`ml-3 ${selected === 'publicaciones' ? 'font-bold' : ''}`}>Publicaciones</h4>
                </div>
                <div className={`w-full text-customBlue text-sm flex items-center py-3 cursor-pointer ${selected === 'material' ? 'bg-blueSelect' : 'hover:bg-blueSelect'}`} onClick={() => handleClick('material')}>
                    <RiBook2Fill className="w-5 h-5 ml-10" />
                    <h4 className={`ml-3 ${selected === 'material' ? 'font-bold' : ''}`}>Material educativo</h4>
                </div>
                <div className={`w-full text-customBlue text-sm flex items-center py-3 cursor-pointer ${selected === 'servicios' ? 'bg-blueSelect' : 'hover:bg-blueSelect'}`} onClick={() => handleClick('servicios')}>
            ...
            <div className="flex flex-col items-start py-6">
                <div className={`w-full text-customBlue flex items-center cursor-pointer py-2 ${selected === 'config' ? 'bg-none' : ''}`} onClick={() => handleClick('config')}>
                    <MdOutlineSettings className="w-5 h-5 ml-10" />
                    <h4 className={`ml-3 font-bold text-sm`}>Configuración</h4>
                </div>
                <hr className="w-4/5 border-t-2 mt-4 mx-auto rounded-full" style={{ borderColor: 'rgba(44,106,156,0.3)' }} />
                <div className="w-full text-customBlue flex items-center pt-6">
                    ...
                    <PiSignOutBold className={`w-6 h-6 ml-8 cursor-pointer ${selected === 'signout' ? 'bg-none' : 'hover:w-8 h-8'}`} />
                </div>
            </div>
        </div>
    );
